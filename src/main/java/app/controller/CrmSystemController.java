...
/*        Query fieldnames = em.createNativeQuery("SELECT distinct [dates] FROM [DATABASEcomision] order by [dates] desc");
    ...
    /*        Bal[] dto = new Gson().fromJson(new InputStreamReader(new FileInputStream("src/main/data.json")), Bal[].class);
            ...
            for(int x = 1; x < 18; x++) {
                ...
                try (InputStreamReader isr = new InputStreamReader(new FileInputStream("src/main/data" + x + ".json"), "UTF-8")) {
                    Bal[] dto = new Gson().fromJson(isr, Bal[].class);
                    List<Bal> divsAllList = Arrays.asList(dto);
                    List<Bal> temp = divsAllList.stream().filter(d -> d.getTIN().equals(data)).collect(Collectors.toList());
            ...
            for(int x = 1; x < 18; x++){
                ...
                try (InputStreamReader isr = new InputStreamReader(new FileInputStream("src/main/data" + x + ".json"), "UTF-8")) {
                    ...
                    if (!temp.toString().equals("[]")) {
                        ...
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Чистий дохід від реалізації продукції (товарів, робіт, послуг)", "2000", jsonObject.get("R2000G3").getAsDouble(), jsonObject.get("R2000G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Чисті зароблені страхові премії", "2010", jsonObject.get("R2010G3").getAsDouble(), jsonObject.get("R2010G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Премії підписані, валова сума", "2011", jsonObject.get("R2011G3").getAsDouble(), jsonObject.get("R2011G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Премії, передані у перестрахування", "2012", jsonObject.get("R2012G3").getAsDouble(), jsonObject.get("R2012G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Зміна резерву незароблених премій, валова сума", "2013", jsonObject.get("R2013G3").getAsDouble(), jsonObject.get("R2013G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Зміна частки перестраховиків у резерві незароблених премій", "2014", jsonObject.get("R2014G3").getAsDouble(), jsonObject.get("R2014G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Собівартість реалізованої продукції (товарів, робіт, послуг)", "2050", jsonObject.get("R2050G3").getAsDouble(), jsonObject.get("R2050G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Чисті понесені збитки за страховими виплатами", "2070", jsonObject.get("R2070G3").getAsDouble(), jsonObject.get("R2070G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Валовий: прибуток", "2090", jsonObject.get("R2090G3").getAsDouble(), jsonObject.get("R2090G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "збиток", "2095", jsonObject.get("R2095G3").getAsDouble(), jsonObject.get("R2095G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дохід (витрати) від зміни у резервах довгострокових зобов’язань", "2105", jsonObject.get("R2105G3").getAsDouble(), jsonObject.get("R2105G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дохід (витрати) від зміни інших страхових резервів", "2110", jsonObject.get("R2110G3").getAsDouble(), jsonObject.get("R2110G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Зміна інших страхових резервів, валова сума", "2111", jsonObject.get("R2111G3").getAsDouble(), jsonObject.get("R2111G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Зміна частки перестраховиків в інших страхових резервах", "2112", jsonObject.get("R2112G3").getAsDouble(), jsonObject.get("R2112G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші операційні доходи", "2120", jsonObject.get("R2120G3").getAsDouble(), jsonObject.get("R2120G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дохід від зміни вартості активів, які оцінюються за справедливою вартістю", "2121", jsonObject.get("R2121G3").getAsDouble(), jsonObject.get("R2121G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дохід від первісного визнання біологічних активів і сільськогосподарської продукції", "2122", jsonObject.get("R2122G3").getAsDouble(), jsonObject.get("R2122G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дохід від використання коштів, вивільнених від оподаткування", "2123", jsonObject.get("R2123G3").getAsDouble(), jsonObject.get("R2123G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Адміністративні витрати", "2130", jsonObject.get("R2130G3").getAsDouble(), jsonObject.get("R2130G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Витрати на збут", "2150", jsonObject.get("R2150G3").getAsDouble(), jsonObject.get("R2150G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші доходи", "2160", jsonObject.get("R2160G3").getAsDouble(), jsonObject.get("R2160G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші витрати", "2165", jsonObject.get("R2165G3").getAsDouble(), jsonObject.get("R2165G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші операційні витрати", "2180", jsonObject.get("R2180G3").getAsDouble(), jsonObject.get("R2180G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Витрат від зміни вартості активів, які оцінюються за справедливою вартістю", "2181", jsonObject.get("R2181G3").getAsDouble(), jsonObject.get("R2181G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Витрат від первісного визнання біологічних активів і сільськогосподарської продукції", "2182", jsonObject.get("R2182G3").getAsDouble(), jsonObject.get("R2182G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Фінансовий результат від операційної діяльності: прибуток", "2190", jsonObject.get("R2190G3").getAsDouble(), jsonObject.get("R2190G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "збиток", "2195", jsonObject.get("R2195G3").getAsDouble(), jsonObject.get("R2195G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дохід від участі в капіталі", "2200", jsonObject.get("R2200G3").getAsDouble(), jsonObject.get("R2200G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші фінансові доходи", "2220", jsonObject.get("R2220G3").getAsDouble(), jsonObject.get("R2220G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші доходи", "2240", jsonObject.get("R2240G3").getAsDouble(), jsonObject.get("R2240G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дохід від благодійної допомоги", "2241", jsonObject.get("R2241G3").getAsDouble(), jsonObject.get("R2241G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Фінансові витрати", "2250", jsonObject.get("R2250G3").getAsDouble(), jsonObject.get("R2250G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Втрати від участі в капіталі", "2255", jsonObject.get("R2255G3").getAsDouble(), jsonObject.get("R2255G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші витрати", "2270", jsonObject.get("R2270G3").getAsDouble(), jsonObject.get("R2270G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Прибуток (збиток) від впливу інфляції на монетарні статті", "2275", jsonObject.get("R2275G3").getAsDouble(), jsonObject.get("R2275G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Разом доходи", "2280", jsonObject.get("R2280G3").getAsDouble(), jsonObject.get("R2280G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Разом витрати (2050 + 2180 + 2270)", "2285", jsonObject.get("R2285G3").getAsDouble(), jsonObject.get("R2285G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Фінансовий результат до оподаткування: прибуток", "2290", jsonObject.get("R2290G3").getAsDouble(), jsonObject.get("R2290G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "збиток", "2295", jsonObject.get("R2295G3").getAsDouble(), jsonObject.get("R2295G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Витрати (дохід) з податку на прибуток", "2300", jsonObject.get("R2300G3").getAsDouble(), jsonObject.get("R2300G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Прибуток (збиток) від припиненої діяльності після оподаткування", "2305", jsonObject.get("R2305G3").getAsDouble(), jsonObject.get("R2305G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Витрати (доходи), які зменшують (збільшують) фінансовий результат після оподаткування", "2310", jsonObject.get("R2310G3").getAsDouble(), jsonObject.get("R2310G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Чистий фінансовий результат: прибуток", "2350", jsonObject.get("R2350G3").getAsDouble(), jsonObject.get("R2350G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "збиток", "2355", jsonObject.get("R2355G3").getAsDouble(), jsonObject.get("R2355G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дооцінка (уцінка) необоротних активів", "2400", jsonObject.get("R2400G3").getAsDouble(), jsonObject.get("R2400G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дооцінка (уцінка) фінансових інструментів", "2405", jsonObject.get("R2405G3").getAsDouble(), jsonObject.get("R2405G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Накопичені курсові різниці", "2410", jsonObject.get("R2410G3").getAsDouble(), jsonObject.get("R2410G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Частка іншого сукупного доходу асоційованих та спільних підприємств", "2415", jsonObject.get("R2415G3").getAsDouble(), jsonObject.get("R2415G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інший сукупний дохід", "2445", jsonObject.get("R2445G3").getAsDouble(), jsonObject.get("R2445G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інший сукупний дохід до оподаткування", "2450", jsonObject.get("R2450G3").getAsDouble(), jsonObject.get("R2450G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Податок на прибуток, пов’язаний з іншим сукупним доходом", "2455", jsonObject.get("R2455G3").getAsDouble(), jsonObject.get("R2455G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інший сукупний дохід після оподаткування", "2460", jsonObject.get("R2460G3").getAsDouble(), jsonObject.get("R2460G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Сукупний дохід (сума рядків 2350, 2355 та 2460)", "2465", jsonObject.get("R2465G3").getAsDouble(), jsonObject.get("R2465G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Матеріальні затрати За звітний період", "2500", jsonObject.get("R2500G3").getAsDouble(), jsonObject.get("R2500G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Витрати на оплату праці", "2505", jsonObject.get("R2505G3").getAsDouble(), jsonObject.get("R2505G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Відрахування на соціальні заходи", "2510", jsonObject.get("R2510G3").getAsDouble(), jsonObject.get("R2510G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Амортизація", "2515", jsonObject.get("R2515G3").getAsDouble(), jsonObject.get("R2515G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Інші операційні витрати", "2520", jsonObject.get("R2520G3").getAsDouble(), jsonObject.get("R2520G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Разом", "2550", jsonObject.get("R2550G3").getAsDouble(), jsonObject.get("R2550G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Середньорічна кількість простих акцій", "2600", jsonObject.get("R2600G3").getAsDouble(), jsonObject.get("R2600G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Скоригована середньорічна кількість простих акцій", "2605", jsonObject.get("R2605G3").getAsDouble(), jsonObject.get("R2605G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Чистий прибуток (збиток) на одну просту акцію", "2610", jsonObject.get("R2610G3").getAsDouble(), jsonObject.get("R2610G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Скоригований чистий прибуток (збиток) на одну просту акцію", "2615", jsonObject.get("R2615G3").getAsDouble(), jsonObject.get("R2615G4").getAsDouble()));
                        res.add(new BalDat(jsonObject.get("TIN").getAsString(), jsonObject.get("FULL_NAME").getAsString(), "Дивіденди на одну просту акцію", "2650", jsonObject.get("R2650G3").getAsDouble(), jsonObject.get("R2650G4").getAsDouble()));
