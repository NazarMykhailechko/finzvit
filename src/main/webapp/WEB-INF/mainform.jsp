        ...
        function getbalance() {
            ...
            $('#balance').DataTable({
                ...
                "initComplete": function(settings, json) {
                    ...
                    let data = $('#balance').DataTable().row(1).data();
...
&lt;%&ndash;        <input type="button" style="background-color: crimson;color: white" onclick="location.href='/managersreports';" value="Управлінські звіти" />&ndash;%&gt;
        <input type="button" style="background-color: crimson;color: white" onClick="window.open('/managersreports','mywindow', 'menubar=no,location=no,resizable=no,scrollbars=no,status=no, width=3000, height=3000'); return false;" value="Управлінські звіти" />
        &lt;%&ndash;<input type="button" style="background-color: crimson;color: white" onclick="location.href='/risk';" value="Кредитні заявки" />&ndash;%&gt;
    </sec:authorize>--%>
...
<%--    <sec:authorize access="hasRole('ROLE_CORP')">
        &lt;%&ndash;        <input type="button" style="background-color: crimson;color: white" onclick="location.href='/managersreports';" value="Управлінські звіти" />&ndash;%&gt;
        &lt;%&ndash;<input type="button" style="background-color: crimson;color: white" onClick="window.open('/managersreports','mywindow', 'menubar=no,location=no,resizable=no,scrollbars=no,status=no, width=3000, height=3000'); return false;" value="Управлінські звіти" />&ndash;%&gt;
        <input type="button" style="background-color: crimson;color: white" onclick="location.href='/corp';" value="Кредитні заявки" />
        <input type="text" id="okpo"/>
        <input type="button" id="getokpo" onclick="getbalance()" style="background-color: crimson;color: white" value="Пошук фінансової звітності" />
    </sec:authorize>--%>
